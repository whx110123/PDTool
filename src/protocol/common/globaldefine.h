...
enum
{
	...
	MYTIME1,			//自定义时间方式，4字节对应秒分时日
	MYTIME2,			//自定义时间方式，6字节对应分时日月年的BCD码
	MYTIME3,			//自定义时间方式，7字节对应年月日时分秒
};
...
#define IEC_103BAOXINNET "国网保信网络103"
#define IEC_103BAOXINNET_NW "南网保信网络103"

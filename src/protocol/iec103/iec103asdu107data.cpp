...
IEC103Asdu107Data::IEC103Asdu107Data(const MyConfig& Config): IEC103Asdu104Data(Config)
{

}

IEC103Asdu107Data::~IEC103Asdu107Data()
{

}

bool IEC103Asdu107Data::handle(const QByteArray& buff)
{
	rii = *(buff.data() + mLen);

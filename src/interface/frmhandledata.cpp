#include "frmhandledata.h"
#include "ui_frmhandledata.h"
#include "app.h"

#include <quiwidget.h>

frmHandleData::frmHandleData(QWidget *parent) :
	QWidget(parent),
	ui(new Ui::frmHandleData)
{
	ui->setupUi(this);
	initForm();
}

frmHandleData::~frmHandleData()
{
	delete ui;
}

void frmHandleData::initForm()
{
	ui->cbcrc->addItems(App::CRClst);
	ui->cbtransform->addItems(App::Transfermode);
}

void frmHandleData::on_pbcrc_clicked()
{
...
void frmHandleData::on_Bt1_clicked()
{
...
void frmHandleData::on_Bt2_clicked()
{
	QString tmp;
	QTextCodec *gbk = QTextCodec::codecForName("GB18030");
	QTextCodec *utf8 = QTextCodec::codecForName("UTF-8");
...
void frmHandleData::on_Bt3_clicked()
{
	QString tmp;
	QTextCodec *gbk = QTextCodec::codecForName("GB18030");
	QTextCodec *utf8 = QTextCodec::codecForName("UTF-8");
...
void frmHandleData::on_Bt4_clicked()
{
	QString tmp;
...
void frmHandleData::on_Bt_clear_clicked()
{
	ui->Le1->clear();
	ui->Le2->clear();
	ui->Le3->clear();
